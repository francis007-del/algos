...
import {dfs,getpath} from './dfs-algo';
...
const DFS=()=>{
    ...
    return(
        <div>
          <Menu refresh={refresh} changeSpeed={changeSpeed} speed={speed} visualize={rundfs} createmaze={createmaze}/>
